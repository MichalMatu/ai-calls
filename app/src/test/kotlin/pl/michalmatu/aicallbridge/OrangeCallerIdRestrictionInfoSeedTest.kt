...
class OrangeCallerIdRestrictionInfoSeedTest {
    @Test
    fun `orange caller id restriction info seed uses one reviewed non committing utterance`() {
        ...
        assertEquals("Jak działa zastrzeganie numeru?", decision.text())
