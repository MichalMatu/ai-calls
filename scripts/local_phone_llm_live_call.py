...
GATE_C_IGNORABLE_PREROLLS = frozenset({"orange", "jakości orange", "5g jakości orange", "kości orange"})
    ...
    try:
        ...
        if len(args) > 2:
            raise ValueError(
                ...
                "[--orange-action greeting|list_capabilities|invoice_status|invoice_topic|internet_problem|roaming_info|roaming_prices|observe_only] [--observe-next]"
            )
