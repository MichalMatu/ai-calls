    ...
    try:
        ...
        if len(args) > 2:
            raise ValueError(
                ...
                "[--orange-action greeting|list_capabilities|invoice_status|invoice_topic|internet_problem|outage_topic|wifi_problem|coverage_info|internet_config|mms_config|manual_network_selection|sms_problem|roaming_info|roaming_prices|observe_only] [--observe-next]"
            )
