    ...
    try:
        ...
        if len(args) > 2:
            raise ValueError(
                ...
                "[--orange-action greeting|list_capabilities|invoice_status|invoice_topic|internet_problem|outage_topic|roaming_info|roaming_prices|observe_only] [--observe-next]"
            )
