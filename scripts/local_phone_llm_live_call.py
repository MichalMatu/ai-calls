    ...
    try:
        ...
        if len(args) > 2:
            raise ValueError(
                ...
                "[--orange-action greeting|list_capabilities|invoice_status|invoice_topic|internet_problem|outage_topic|wifi_problem|roaming_info|roaming_prices|observe_only] [--observe-next]"
            )
