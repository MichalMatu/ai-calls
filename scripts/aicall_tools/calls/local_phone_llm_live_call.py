...
from aicall_tools.calls.autonomous_call_loop import wait_for_active_call, wait_for_audio_signal, wait_for_idle
from aicall_tools.realtime.realtime_live_call_smoke import validate_live_preflight
from aicall_tools.realtime.realtime_network_smoke import PACKAGE_NAME, PROBE_ACTIVITY, is_direct_usb_target
from aicall_tools.device.s22_call_control import Adb, normalize_number
...
GATE_C_IGNORABLE_PREROLLS = frozenset({"orange", "jakości orange", "5g jakości orange", "kości orange", "wielkości orange", "g jakości orange", "wie jakości orange"})
